...
####### Install ggthemes package if the not already installed #######################
...
Deaths <- read.csv("D://Academic/SCU_Q1//R_Programming//R_Studio//Accidental_Drug_Related_Deaths_2012-2018.csv", stringsAsFactors = FALSE)

######################### Fact 1 : Timeline Analysis  ############################################################

######################### Part A - Increase in number of deaths over the Years Plot ##########################################
...
################################## Part B - Drug related deaths over the years #########################################33
